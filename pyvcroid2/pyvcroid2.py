...
class VcRoid2(object):
    ...
    def __init__(self, *, install_path = None, install_path_x86 = None):
        ...
        # Open the DLL
        self.__dll = windll.LoadLibrary(self.__install_path_x86 + "\\aitalked.dll")
        ...
        config = aitalk.TConfig(
            ...
            pathLicense = (self.__install_path_x86 + "\\aitalk.lic").encode("shift-jis"),
    ...
    def loadLanguage(self, language_name):
        ...
        cd = os.getcwd()
        try:
            os.chdir(self.__install_path_x86) # Change the current directory temporarily
